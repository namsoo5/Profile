...
***
* [`급행열차`](https://github.com/namsoo5/if_ExpressTrain) - if해커톤
...
***
* [`단비`](https://github.com/namsoo5/DanBee_iOS) - 전동킥보드 공유 플랫폼 교내 프로젝트
    * 진행기간 : 2019.04 ~ 2019.09.14
    ...
    * 기여도 : iOS(100%), Server(100%), Android(30%), Arduino(50%)
    * 사용스킬 : **iOS, Swift, Android, PHP, Arduino, NaverAPI, KakaoAPI**
   
<br>

*** 
* [`Life-M`](https://github.com/namsoo5/SanitaryPadSharingService-iOS) - 엔젤핵 해커톤
